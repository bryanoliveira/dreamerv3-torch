#!/bin/bash
python dreamer.py --logdir ./logdir/$(date "+%Y%m%d_%H%M%S")-sldp_onehot_w4 --configs sldp --seed 176 --batch_size 48 --train_ratio 3072 --env__w 4
python dreamer.py --logdir ./logdir/$(date "+%Y%m%d_%H%M%S")-sldp_onehot_w4 --configs sldp --seed 568 --batch_size 48 --train_ratio 3072 --env__w 4
python dreamer.py --logdir ./logdir/$(date "+%Y%m%d_%H%M%S")-sldp_onehot_w4 --configs sldp --seed 907 --batch_size 48 --train_ratio 3072 --env__w 4
