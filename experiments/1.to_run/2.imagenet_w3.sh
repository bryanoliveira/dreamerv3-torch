...
bash experiments/experiment.sh ./logdir/$(date "+%Y%m%d_%H%M%S")-imagenet_w3 --configs sldp_image --seed 271 --env__w 3 --env__image_folder imagenet-1k
...
bash experiments/experiment.sh ./logdir/$(date "+%Y%m%d_%H%M%S")-imagenet_w3 --configs sldp_image --seed 758 --env__w 3 --env__image_folder imagenet-1k
