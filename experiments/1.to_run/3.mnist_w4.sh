...
bash experiments/experiment.sh ./logdir/$(date "+%Y%m%d_%H%M%S")-mnist_w4 --configs sldp_image --seed 271 --env__w 4 --env__image_folder mnist
...
bash experiments/experiment.sh ./logdir/$(date "+%Y%m%d_%H%M%S")-mnist_w4 --configs sldp_image --seed 758 --env__w 4 --env__image_folder mnist
