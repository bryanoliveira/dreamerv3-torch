#!/bin/bash
python dreamer.py --logdir ./logdir/$(date "+%Y%m%d_%H%M%S")-sldp_onehot_w2 --configs sldp --seed 176 --batch_size 64 --train_ratio 4096
python dreamer.py --logdir ./logdir/$(date "+%Y%m%d_%H%M%S")-sldp_onehot_w2 --configs sldp --seed 568 --batch_size 64 --train_ratio 4096
python dreamer.py --logdir ./logdir/$(date "+%Y%m%d_%H%M%S")-sldp_onehot_w2 --configs sldp --seed 907 --batch_size 64 --train_ratio 4096
